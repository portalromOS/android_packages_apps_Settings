...
public class PortalRomVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "portalromVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_PORTALROM_VERSION_PROP = "ro.portalrom.display.version";
    ...
    public PortalRomVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_PORTALROM_VERSION_PROP,
    ...
    public void copy() {
        Sliceable.setCopyContent(mContext, getSummary(),
                mContext.getText(org.portalrom.platform.internal.R.string.portalrom_version));
    }
}
